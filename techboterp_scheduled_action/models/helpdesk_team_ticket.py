...
class IrCron(models.Model):
    ...
    def _send_help_team_ticket_report(self):
        ...
        XLSX_REPORT_ID = 'techboterp_scheduled_action.action_report_helpdesk_team_ticket_xlsx'
        ...
        team_admin_emails = ','.join([user.email for user in self.env.ref(
            'techboterp_scheduled_action.group_team_ticket_report_mail_send').users])
        mail_values = {
